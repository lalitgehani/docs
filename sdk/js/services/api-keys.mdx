...
```ts
{
  "id": "key-id-2",
  "name": "My Integration",
  "key": "sb_ak.eyJ2ZXJzaW9uIjoxLCJ0eXBlIjoiYXBpX2tleSIsLi4uLng5azI=",  // Full key - save this!
  "is_active": true,
...
const client = new SnackBaseClient({
  baseUrl: "https://api.example.com",
  apiKey: "sb_ak.eyJ2ZXJzaW9uIjoxLCJ0eXBlIjoiYXBpX2tleSIsLi4uLng5azI="
});
```
