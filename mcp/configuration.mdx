...
MCP uses **API keys only**. There are no tools for password login, OAuth, SAML, register, or password reset. Agents act as the key’s principal.
...
- **Avoid superadmin keys** in shared agent sessions — they can manage jobs and system-wide configuration
- **Monitor usage** via audit logs
- **Revoke compromised keys** immediately
- **Never paste keys into prompts** or commit them to version control
